...
export default function ProductItemlist({ item }) {
    ...
    return (
        <div className="w-full">
            <div className='grid grid-cols-7 gap-2 text-[15px] py-2 border-y-2 bg-sky-50 w-full  rounded-lg border-2 mt-1 hover:border-sky-500'  >
                ...
                <button onClick={() => deleteProduct(item)} className="col-span-1 bg-red-500 h-[35px] w-[80px] flex justify-self-center justify-center items-center  font-bold  rounded-full border-2 text-white hover:text-red-500 hover:bg-white hover:border-red-500">delete</button>
            </div>
        </div>
    )
}