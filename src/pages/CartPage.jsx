        ...
        <div className="flex flex-col mb-40">
            <div className='grid grid-cols-4 gap-4 w-[1200px] '>
                <div className="col-span-3  justify-center items-center">
                    <div className="grid grid-cols-3 text-[20px] font-semibold  border-y-2 border-sky-300 h-[50px]  bg-sky-50">
                    ...
                    <div className="grid grid-cols-3 h-[110px] text-[20px] font-semibold border-b-2 border-sky-300 ">
