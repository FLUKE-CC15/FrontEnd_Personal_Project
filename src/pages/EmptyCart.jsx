...
export default function EmptyCart() {
    return <div className=''>
        <div className="w-full h-[400px] flex flex-col justify-center items-center ">
            ...
            <Link to='/'><button class="w-[300px] m-3 px-4 py-1 font-bold text-[20px] bg-sky-500 border-2 border-sky-600 hover:border-sky-500 hover:bg-gray-100 hover:text-sky-600 text-white rounded-xl">Back to Home</button></Link>
        </div>
